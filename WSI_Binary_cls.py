...
Original file is located at
    https://colab.research.google.com/drive/1OF6dhYTFBXURz1m3EVvFUoqfw9dJrtaz
"""

from google.colab import drive
drive.mount('/content/drive')

cd /content/drive/My Drive/Using Keras Pre-trained Deep Learning models/Binarycls/Efficient/B7
...
benign_train = np.array(Dataset_loader('/content/drive/My Drive/BreaKHis_v1/40X/benign',224))
malign_train = np.array(Dataset_loader('/content/drive/My Drive/BreaKHis_v1/40X/malignant',224))
